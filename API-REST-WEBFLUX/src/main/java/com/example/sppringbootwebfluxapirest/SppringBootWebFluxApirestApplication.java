...
public class SppringBootWebFluxApirestApplication implements CommandLineRunner {
    ...
    private static final Logger log = LoggerFactory.getLogger(SppringBootWebFluxApirestApplication.class);

    public static void main(String[] args) {
        SpringApplication.run(SppringBootWebFluxApirestApplication.class, args);
    }
